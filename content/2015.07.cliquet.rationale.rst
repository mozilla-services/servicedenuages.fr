...
* **Les formats** : le format et la structure JSON des réponses est imposé, ainsi
  ...
  ou la syntaxe pour filtrer/trier les resources via la *querystring*.
...
En rêve, il existerait plusieurs implémentations avec des technologies différentes
...
Est-il possible de faire ci ou ça avec Cliquet ?
    ...
    <https://github.com/mozilla-services/cliquet/issues>`_ !
    (*ex. brancher authentification Github, changer le format du logging JSON, stocker des
