...
Il est `documenté en détail <http://cliquet.readthedocs.io/en/latest/api/index.html>`_.
...
de l'éco-système <http://cliquet.readthedocs.io/en/latest/ecosystem.html>`_.
...
Nous avons écrit un `guide de démarrage <http://cliquet.readthedocs.io/en/latest/quickstart.html>`_,
...
de temps. Et comme nous l'exposions dans `l'article précédent <{filename}/2015.07.whistler-use-cases.rst>`_, il y a du potentiel !
...
* **La documentation d'API** : actuellement, nous n'avons pas de solution pour qu'un
  ...
  `la documentation de l'API <http://cliquet.readthedocs.io/en/latest/api/index.html>`_
  obtenue.
