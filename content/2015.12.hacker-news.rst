...
Kinto-un is the name of the flying nimbus in Dragon ball. It's said that
"the cloud can only be ridden by someone with a pure heart". Oh, well.
...
That is true, but `we're working on it pretty hard
<https://github.com/Kinto/kinto-admin >`. If you want, you can have a look at
it now, even though it's fairly new.
