...
solution de stockage générique. On refait `Daybed <http://daybed.readthedocs.io>`_
chez Mozilla !
...
`Cliquet <http://cliquet.readthedocs.io/>`_, ce fût l'occasion de mettre au
point `un protocole très simple
<http://cliquet.readthedocs.io/en/latest/api/>`_, fortement inspiré de
...
<http://cliquet.readthedocs.io/en/latest/rationale.html>`_ seront bien entendu
à l'honneur :)
...
Si nous basons le service sur *Cliquet*, comme c'est le cas avec `Kinto <http://kinto.readthedocs.io>`_,
