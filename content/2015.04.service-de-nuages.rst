...
<https://readinglist.readthedocs.io>`_ (*Reading List*) a vu le jour.  L'idée
...
`Cliquet <https://cliquet.readthedocs.io>`_, dont l'idée principale est de
...
<http://kinto.readthedocs.io>`_ en est encore à ses balbutiements mais c'est
