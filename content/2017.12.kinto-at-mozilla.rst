...
Average requests/sec
  1100 (70K/min)
Data size
  XXX millions buckets, XXX collections, XXX records
...
Of course, there is some amount of technical debt that could be tackled here and there. And to be honest we don't see a huge amount of external contributions and pull requests on the Kinto Github org. The `bus factor <https://en.wikipedia.org/wiki/Bus_factor>`_ is quite high!
