    ...
    dot {
        digraph integrated {
            ...
            subgraph cluster_internal {
                ...
                Kinto -> endpoint [label=3];
            }
            Queue [shape=box];
            internal_queue -> Queue [label=2, dir=both];
            Consumer [shape=box];
            endpoint -> Consumer [label=4, dir=both];
        }
    }
%}
Pros:
