...
notre solution `Kinto <https://kinto.readthedocs.io>`_.
...
présentation le `tutorial d'introduction <http://kintojs.readthedocs.io/en/latest/tutorial/>`_.
...
puisque Rémy a mis en place un `serveur de dev effacé tous les jours <https://demo.kinto-storage.org/v1/>`_.
...
l'époque avec `Daybed <http://daybed.readthedocs.io/>`_. Voici donc une belle opportunité à saisir !
