...
1. Let the user enter the location of its Kinto instance, the first time.
...
.. image:: {filename}/images/KintoDiscovery-1st-time-sync.png
    :alt: The first time the user set its Kinto server URI
    :align: center
...
- Its really easy to setup and implement.
