...
déléguant la gestion du DNS à Alwaysdata soit en configurant la zone
...
- **Répertoire de travail** : ``/kinto/``
- **Version de Python** : ``Version par défaut``
- **Répertoire du virtualenv** : ``/kinto/venv/``
- **Chemins statiques** : ``/attachments/=/kinto/attachments/``
...
Si vous utilisez un autre système d'authenficiation, vous aurez
...
Vous pouvez également créer un groupe et utiliser se groupe comme identifiant.
