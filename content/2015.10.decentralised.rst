...
vision de Kinto est celle d'un hébergement communautaire décentralisé
...
qui ont vocation à être partagées ou de données qui sont les votre et qui
...
La mise en place de serveurs communautaires n'empêche bien sur pas l'utilisation
