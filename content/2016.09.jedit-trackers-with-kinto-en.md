...
This is a labor of love for us, contributing during our free time.
I don't always have an Internet access on holidays. Or it's via a short ethernet cable in a dark and overheated room.
Don't lock me out of the sunny garden! Give me everything I need offline!
...
### My Goals
 ...
 - better ticket search and vizualization;
...
it supports only a conjuction of `key: [value1, value2, ...]` parameters. Querying the `id`, `_status`, `last_modified`
...
A few ideas to work arround that:
...
When there are no deletions I can update them incrementaly, otherwise I have to go through the whole collection
to recompute them.
