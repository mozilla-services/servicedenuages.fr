...
seule la conjonction de `clé: [valeur1, valeur2, ...]` est supportée. Seul le premier critère a une chance d'être
optimisé, si j'ai bien suivi le [code](https://github.com/Kinto/kinto.js/blob/f48ea470ddb2c6398acc386439043e6cae8bffe4/src/adapters/IDB.js#L325). Ensuite,
